...
class Panganiban50701 extends Frame implements ActionListener, WindowListener{
	TextField T1, T2, T3;
	Label L1, L2, L3, label;
	Button B1, B2;
	
	Panganiban50701(String s){
		super(s);
...
class PanganibanACMLabExer50701 {
	public static void main(String[] args) {
		new Panganiban50701("Example");
	}
}
